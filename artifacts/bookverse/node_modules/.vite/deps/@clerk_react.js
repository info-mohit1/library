...
import {
  ...
  useWaitlist,
  withClerk
} from "./chunk-ACDLNORL.js";
import "./chunk-HVCNMHSW.js";
import {
  require_react_dom
...
// ../../node_modules/.pnpm/@clerk+react@6.5.0_react-do_bc675215c15104fff54ebb95299b3e7d/node_modules/@clerk/react/dist/index.mjs
...
// ../../node_modules/.pnpm/@clerk+shared@4.9.0_react-d_adccf361f4095d32882ba77e7af6ae11/node_modules/@clerk/shared/dist/runtime/getToken.mjs
var TIMEOUT_MS = 1e4;
...
var SignUpButton = withClerk(
  ({ clerk, children, ...props }) => {
    ...
    const childProps = { ...rest, onClick: wrappedChildClickHandler };
    return import_react4.default.cloneElement(child, childProps);
  },
...
function HandleSSOCallback(props) {
  ...
  const hasRun = (0, import_react5.useRef)(false);
  ...
  return import_react5.default.createElement("div", null, import_react5.default.createElement("div", { id: "clerk-captcha" }));
}
