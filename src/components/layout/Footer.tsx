      ...
      <div className="container mx-auto px-4 py-14 md:py-16">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="max-w-xs text-sm text-[#E5DCCF]/70 leading-relaxed">
              A beautifully curated digital library where book lovers discover,
              explore, and borrow books from the comfort of their home.
            </p>
            <div className="flex items-center gap-4 pt-2">
              <a
                href="#"
                aria-label="Twitter"
                className="text-[#E5DCCF]/50 hover:text-[#A3501E] transition-colors"
              >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link
                  href="/all-books"
                  className="text-[#E5DCCF]/60 hover:text-[#A3501E] transition-colors"
                >
                  All Books
                </Link>
              </li>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[#E5DCCF]/10 pt-8 md:flex-row text-xs text-[#E5DCCF]/40">
          ...
          <div className="flex gap-6">
            <a href="#" className="hover:text-[#A3501E] transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="hover:text-[#A3501E] transition-colors">
              Terms of Service
